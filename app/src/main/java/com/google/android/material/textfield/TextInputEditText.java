...
public class TextInputEditText extends C0267x {

    /* renamed from: f, reason: collision with root package name */
    public final Rect f1992f;
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        ...
        int[] iArr = AbstractC0373a.f4147D;
    ...
    public final void getFocusedRect(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout == null || !this.f1993g || rect == null) {
            return;
        }
        Rect rect2 = this.f1992f;
    ...
    public final boolean getGlobalVisibleRect(Rect rect, Point point) {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout == null || !this.f1993g) {
    ...
    public CharSequence getHint() {
        TextInputLayout textInputLayout = getTextInputLayout();
        return (textInputLayout == null || !textInputLayout.f2001E) ? super.getHint() : textInputLayout.getHint();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f2001E && super.getHint() == null) {
    ...
    @Override // l.C0267x, android.widget.TextView, android.view.View
