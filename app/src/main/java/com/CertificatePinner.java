...
public final class CertificatePinner {
    ...
    public static final class Pin {
        ...
        Pin(String str, String str2) {
            this.pattern = str;
            this.canonicalHostname = str.startsWith(WILDCARD) ? HttpUrl.parse("http://" + str.substring(WILDCARD.length())).host() : HttpUrl.parse("http://" + str).host();
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof CertificatePinner) && com.tencent.Util.equal(this.certificateChainCleaner, ((CertificatePinner) obj).certificateChainCleaner) && this.pins.equals(((CertificatePinner) obj).pins);
    }
    ...
    public CertificatePinner withCertificateChainCleaner(CertificateChainCleaner certificateChainCleaner) {
        return com.tencent.Util.equal(this.certificateChainCleaner, certificateChainCleaner) ? this : new CertificatePinner(this.pins, certificateChainCleaner);
    }
}
