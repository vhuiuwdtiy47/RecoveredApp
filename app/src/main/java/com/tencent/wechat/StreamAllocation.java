...
public final class StreamAllocation {
    ...
    private RealConnection findConnection(int i, int i2, int i3, boolean z2) throws IOException {
        Socket socket = null;
                ...
                if (this.connection != null) {
                    ...
                    synchronized (this.connectionPool) {
                        ...
                        if (this.connection != null) {
                            ...
                            realConnection2.connect(i, i2, i3, z2);
    ...
    private RealConnection findHealthyConnection(int i, int i2, int i3, boolean z2, boolean z3) throws IOException {
        RealConnection findConnection;
        while (true) {
            findConnection = findConnection(i, i2, i3, z2);
            synchronized (this.connectionPool) {
    ...
    public HttpCodec newStream(OkHttpClient okHttpClient, boolean z2) {
        try {
            HttpCodec newCodec = findHealthyConnection(okHttpClient.connectTimeoutMillis(), okHttpClient.readTimeoutMillis(), okHttpClient.writeTimeoutMillis(), okHttpClient.retryOnConnectionFailure(), z2).newCodec(okHttpClient, this);
            synchronized (this.connectionPool) {
                this.codec = newCodec;
            }
            return newCodec;
    ...
    public void streamFinished(boolean z2, HttpCodec httpCodec) {
        Socket deallocate;
        synchronized (this.connectionPool) {
            if (httpCodec != null) {
