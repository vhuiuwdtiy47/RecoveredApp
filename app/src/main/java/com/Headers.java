        ...
        private void checkNameAndValue(String str, String str2) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (charAt <= ' ' || charAt >= 127) {
                    throw new IllegalArgumentException(com.tencent.Util.format("Unexpected char %#04x at %d in header name: %s", Integer.valueOf(charAt), Integer.valueOf(i), str));
                }
            }
            if (str2 == null) {
            ...
            for (int i2 = 0; i2 < length2; i2++) {
                ...
                if ((charAt2 <= 31 && charAt2 != '\t') || charAt2 >= 127) {
                    throw new IllegalArgumentException(com.tencent.Util.format("Unexpected char %#04x at %d in %s value: %s", Integer.valueOf(charAt2), Integer.valueOf(i2), str, str2));
                }
            }
        }
